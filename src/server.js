...
var cors = require('cors'); //Ensure our body-parser tool has been added
...
************************************/
app.get('/sexNumber', function(req, res){
  console.log('69');
  res.send('holynumbergiven');

});

app.get('/getAllPets', function(req, res){
  db.any('SELECT * FROM pet_names')
  .then(function(rows)
    {res.send(rows);})
  .catch(function(err)
